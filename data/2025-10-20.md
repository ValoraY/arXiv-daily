...
### [38] [When Seeing Is not Enough: Revealing the Limits of Active Reasoning in MLLMs](https://arxiv.org/abs/2510.15421)
...
#### 📄 Abstract
Multimodal large language models (MLLMs) have shown strong capabilities
...
### [39] [MCA: Modality Composition Awareness for Robust Composed Multimodal Retrieval](https://arxiv.org/abs/2510.15543)
...
### [40] [Leveraging LLMs for Context-Aware Implicit Textual and Multimodal Hate Speech Detection](https://arxiv.org/abs/2510.15685)
...
### [42] [AUGUSTUS: An LLM-Driven Multimodal Agent System with Contextualized User Memory](https://arxiv.org/abs/2510.15261)
...
#### 📄 Abstract
Riding on the success of LLMs with retrieval-augmented generation (RAG),
...
### [43] [WebGen-V Bench: Structured Representation for Enhancing Visual Design in LLM-based Web Generation and Evaluation](https://arxiv.org/abs/2510.15306)
...
#### 📄 Abstract
Witnessed by the recent advancements on leveraging LLM for coding and
...
### [44] [VERITAS: Leveraging Vision Priors and Expert Fusion to Improve Multimodal Data](https://arxiv.org/abs/2510.15317)
...
#### 📄 Abstract
The quality of supervised fine-tuning (SFT) data is crucial for the
...
### [45] [Towards Flash Thinking via Decoupled Advantage Policy Optimization](https://arxiv.org/abs/2510.15374)
...
#### 📄 Abstract
Recent Large Reasoning Models (LRMs) have achieved remarkable performance in
...
### [46] [Hypergraph Contrastive Sensor Fusion for Multimodal Fault Diagnosis in Induction Motors](https://arxiv.org/abs/2510.15547)
...
#### 📄 Abstract
Reliable induction motor (IM) fault diagnosis is vital for industrial safety
...
### [47] [Towards Relaxed Multimodal Inputs for Gait-based Parkinson's Disease Assessment](https://arxiv.org/abs/2510.15748)
...
#### 📄 Abstract
Parkinson's disease assessment has garnered growing interest in recent years,
